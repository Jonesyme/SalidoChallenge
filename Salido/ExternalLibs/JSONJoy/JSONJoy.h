...
/**
 ...
 @param JSONObject is a json Object or json String to parse.
...
/**
 ...
 @param loose if loose should be enabled. Default is NO.
 */
...
/**
 ...
 @param box if auto boxing of BOOLs should be enabled. Default is YES.
 */
